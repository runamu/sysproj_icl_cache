...
def main(enable_cache=False, cuda_device=0, result_file_name=None):
    ...
    cache_engine.add_schema(read_file("../sst2.xml", preproc), max_tokens=800)
    ...
    with open('../dataset/sst2/sst2_train.jsonl', 'r') as file:
        ...
        for i in range(100, len(lines)):
            ...
            question = format_sst2(question_data, with_answer=False)
